...
public class MChartView extends ChartView{
	...
	public MChartView(Context context) {
	 ...
	 public MChartView(Context context, AttributeSet attrs){
	        super(context, attrs);   
	        
	 }
	 
	 public MChartView(Context context, AttributeSet attrs, int defStyle) {
